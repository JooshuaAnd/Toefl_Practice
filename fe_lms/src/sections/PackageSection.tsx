...
export const PackageSection: React.FC = () => {
  return (
    <section id="packages" className="relative w-full py-24 px-4 overflow-visible">
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center space-y-16">
        <SectionHeader
          badge="Packages"
          title="Choose Your Preparation Plan"
          description="Flexible packages designed for individual learners and corporate teams. Start with a free trial, then pick the plan that fits your goals."
        />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`p-1.5 rounded-lg ${
                    plan.target === "Company" ? "bg-purple-50 text-purple-600" : "bg-brand-light/10 text-brand-dark"
                  }`}>
                    {plan.target === "Company" ? (
                ...
                <p className="font-inter text-slate-400 text-xs leading-relaxed min-h-[36px]">
                  {plan.description}
                </p>
